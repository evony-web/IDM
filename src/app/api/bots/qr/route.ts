...
// Support Railway URL or fallback to localhost
const WA_BOT_URL = process.env.WHATSAPP_BOT_URL || 'http://localhost:6002';

// GET /api/bots/qr — Check QR code availability from WhatsApp bot
export async function GET() {
  try {
    const statusRes = await fetch(`${WA_BOT_URL}/api/whatsapp/health`, {
