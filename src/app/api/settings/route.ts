...
const DEFAULT_SETTINGS: Record<string, string> = {
  ...
  loading_video_url: process.env.NEXT_PUBLIC_LOADING_VIDEO_URL || 'https://res.cloudinary.com/dagoryri5/video/upload/v1775995492/c22b61a248ac92df5b6b33c97427f149_lk2ahs.mp4',
