...
const DEFAULT_SETTINGS: Record<string, string> = {
  ...
  loading_video_url: process.env.NEXT_PUBLIC_LOADING_VIDEO_URL || 'https://res.cloudinary.com/dagoryri5/video/upload/v1775996353/40135b48f64f507a99eb4dfd7a012033_mbsiip.mp4',
