...
function PodiumCard({
  ...
  // ⚡ PERFORMANCE-OPTIMIZED CARD CLASSES
  // Rank 1: card-gold-enhanced (VIP - 1 card only)
  // Rank 2-3: card-pro (max 3 cards)
  const cardOuterClass = rank === 1
    ? 'card-gold-enhanced card-corner-accent'  // VIP treatment
    : 'card-pro';  // Highlight for rank 2-3
...
/* ================================================================
   ...
   Uses: .card-float .card-accent-line .card-inner-glow
   Performance: LIGHT - Safe for long lists
   ================================================================ */
...
/* ================================================================
   Stats Summary Card — Performance Optimized
   Uses: .card-float .card-accent-line
   Performance: LIGHT - GPU-friendly
   ================================================================ */
...
export function Leaderboard({ division, players, currentUserId, onPlayerClick }: LeaderboardProps) {
  ...
  return (
    <div className="space-y-5">
      {/* =============================================
          Hero Header — Performance Optimized
          Uses: .card-pro (highlight card - shimmer on hover)
          ============================================= */}
      <motion.div
        className="card-pro card-corner-accent rounded-3xl p-6"
      ...
      {/* =============================================
          Top 3 Podium — Ultra Premium with Optimized Cards
          Container uses: .card-pro (highlight)
          Individual cards: .card-gold-enhanced (rank 1), .card-pro (rank 2-3)
          ============================================= */}
      {topThree.length > 0 && (
        <motion.div
          className="card-pro rounded-3xl p-4 sm:p-5 lg:p-8 pt-5 sm:pt-7 lg:pt-10"
      ...
      {/* Search no results — Performance Optimized */}
