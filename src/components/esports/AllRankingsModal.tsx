        ...
        >
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: isMale
                ? '0 0 60px rgba(115,255,0,0.08), 0 25px 50px -12px rgba(0,0,0,0.5)'
                : '0 0 60px rgba(244,114,182,0.08), 0 25px 50px -12px rgba(0,0,0,0.5)',
            }}
          ...
          >
            ...
            <div className="relative px-5 pt-3 pb-4 border-b border-white/[0.06]">
              ...
              <div
                ...
                style={{
                  background: isMale
                    ? 'linear-gradient(90deg, transparent, rgba(115,255,0,0.6), transparent)'
                    : 'linear-gradient(90deg, transparent, rgba(244,114,182,0.6), transparent)',
                  boxShadow: isMale
                    ? '0 0 16px rgba(115,255,0,0.4)'
              ...
              <div className="flex items-center gap-3.5">
                <div
                  ...
                  style={{
                    background: isMale
                      ? 'linear-gradient(135deg, rgba(115,255,0,0.16), rgba(95,212,0,0.06))'
                      : 'linear-gradient(135deg, rgba(244,114,182,0.16), rgba(236,72,153,0.06))',
                  }}
                >
                    ...
                    <div className="flex items-end justify-center gap-2 mb-4 pt-2 pb-3">
                      ...
                      <div className="flex flex-col items-center flex-1 max-w-[90px]">
                        ...
                        <div
                          ...
                          style={{
                            background: isMale
                              ? 'linear-gradient(135deg, #73FF00, #5FD400)'
                              : 'linear-gradient(135deg, #F472B6, #EC4899)',
                            color: '#000',
                            boxShadow: isMale
                              ? '0 0 12px rgba(115,255,0,0.3)'
