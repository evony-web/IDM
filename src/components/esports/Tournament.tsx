          ...
          Gabung Turnamen
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white/[0.04] border border-white/[0.06] rounded-xl px-4 py-3 min-h-[44px] text-white/90 text-sm placeholder-white/25 focus:outline-none focus:border-[#73FF00]/30 focus:bg-white/[0.06] focus:ring-1 focus:ring-[#73FF00]/10 transition-all"
                    />
                  </div>

                  {/* WA + City side by side — stack on very small screens */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="08xxx"
                        className="w-full bg-white/[0.04] border border-white/[0.06] rounded-xl px-3.5 py-3 min-h-[44px] text-white/90 text-[13px] placeholder-white/25 focus:outline-none focus:border-[#73FF00]/30 focus:bg-white/[0.06] focus:ring-1 focus:ring-[#73FF00]/10 transition-all"
                      />
                    </div>
            ...
            {pendingRegistrations.length > 0 && (
              <motion.div variants={itemVariants} className="space-y-2">
                ...
                <div className="max-h-64 overflow-y-auto space-y-2 pr-0.5" style={{ scrollbarWidth: 'thin', scrollbarColor: isMale ? 'rgba(115,255,0,0.12) transparent' : 'rgba(56,189,248,0.12) transparent' }}>
            ...
            {approvedRegistrations.length > 0 && (
              <motion.div variants={itemVariants} className="space-y-2">
                ...
                <div className="max-h-72 overflow-y-auto space-y-2 pr-0.5" style={{ scrollbarWidth: 'thin', scrollbarColor: isMale ? 'rgba(115,255,0,0.12) transparent' : 'rgba(56,189,248,0.12) transparent' }}>
