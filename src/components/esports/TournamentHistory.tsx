              ...
              <div className="flex items-center gap-3 flex-wrap">
                <span
                  className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[11px] font-semibold ${
                    isMale
                      ? 'bg-[#73FF00]/12 text-[#73FF00] border border-[#73FF00]/15'
                      : 'bg-[#0EA5E9]/12 text-[#38BDF8] border border-#0EA5E9/15'
                  }`}
                >
        ...
        {completedTournaments.length === 0 && ongoingTournaments.length === 0 ? (
          ...
          >
            <div className="relative w-20 h-20 mx-auto mb-5">
              <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#73FF00]/10 to-[#38BDF8]/10 blur-xl" />
              <div className="relative w-20 h-20 rounded-3xl glass-subtle flex items-center justify-center">
                <Trophy
                  className={`w-9 h-9 ${isMale ? 'text-[#73FF00]/30' : 'text-[#38BDF8]/30'}`}
                />
              </div>
            </div>
          ...
          >
            <div className="relative w-16 h-16 mx-auto mb-4">
              <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#73FF00]/8 to-[#38BDF8]/8 blur-lg" />
              <div className="relative w-16 h-16 rounded-2xl glass-subtle flex items-center justify-center">
                <Crown
                  className={`w-7 h-7 ${isMale ? 'text-[#73FF00]/25' : 'text-[#38BDF8]/25'}`}
                />
              </div>
            </div>
                  ...
                  <div className="flex-shrink-0 flex flex-col items-center gap-2">
                    <div
                      className={`w-12 h-12 rounded-2xl flex items-center justify-center ${
                        isMale ? 'bg-[#73FF00]/10' : 'bg-[#0EA5E9]/10'
                      }`}
                    >
                      <Trophy
                        className={`w-6 h-6 trophy-glow ${isMale ? 'text-[#73FF00]' : 'text-[#38BDF8]'}`}
                      />
                    </div>
          ...
          <div className="glass rounded-2xl p-4 text-center card-3d">
            <div
              className={`w-11 h-11 rounded-2xl mx-auto mb-2.5 flex items-center justify-center ${
                isMale ? 'bg-[#73FF00]/12' : 'bg-[#0EA5E9]/12'
              }`}
            >
              <Crown
                className={`w-5 h-5 ${isMale ? 'text-[#73FF00]' : 'text-[#38BDF8]'}`}
              />
            </div>
